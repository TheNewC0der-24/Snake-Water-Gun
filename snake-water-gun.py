...
if __name__ == "__main__":
    ...
    while (attempts<=10):
        ...
        if inp=='s' and ran=='s':
            print("Tie")
            print(f"\nYou choose snake and Computer also choose snake! ")
            ...
            print("Tie")
            print(f"\nYou choose water and Computer also choose water! ")
            print("No body gets point\n")
            tie_music()
            ...
            print("Tie")
            print(f"\nYou choose gun and Computer also choose gun! ")
            print("No body gets point\n")
            tie_music()
            ...
            print(f"\nYou choose snake and Computer chosoe gun! ")
            computer_point=computer_point+1
        ...
        print("\nNo. of rounds left: {}".format(10 - attempts))
        attempts = attempts + 1
